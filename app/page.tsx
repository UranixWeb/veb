    ...
    return (
      <div id={allChecked ? "login-container-green" : "login-container"}>
        <div className={allChecked ? "vareni-card-green" : "vareni-card"}>
          ...
          <button id="back" onClick={() => {setWarning(""); {currentLevel === "vareni" ? (resetUser) : (setStatus("vareni"))}}}><svg id="backsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576C461.4 576 576 461.4 576 320zM188.7 308.7L292.7 204.7C297.3 200.1 304.2 198.8 310.1 201.2C316 203.6 320 209.5 320 216L320 272L416 272C433.7 272 448 286.3 448 304L448 336C448 353.7 433.7 368 416 368L320 368L320 424C320 430.5 316.1 436.3 310.1 438.8C304.1 441.3 297.2 439.9 292.7 435.3L188.7 331.3C182.5 325.1 182.5 314.9 188.7 308.7z"/></svg></button>
        </div>
      </div>
    )
  } else if (status === "vareni") {
    ...
    return (
      <>
        ...
        <div id='vareni-alert-done'>
          ...
          <button onClick={() => {setStatus("seeVareni"); getVareni}}>Vaření <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg></button>
        </div>
      ) : (
        ...
        <div id='userbar'>        {currentLevel === "admin" ? (
          <div id='adminbar'>
            ...
            <button onClick={() => {setStatus("vareni"); getVareni()}} id='addpost'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M 0 68 Q 1.6 50.4 19.2 48.8 L 56 48.8 L 56 48.8 Q 83.2 50.4 96 74.4 L 424.8 74.4 L 424.8 74.4 Q 440.8 75.2 450.4 87.2 Q 459.2 99.2 456 114.4 L 431.2 206.4 L 431.2 206.4 Q 414.4 202.4 396.8 202.4 Q 355.2 203.2 322.4 224 Q 289.6 244.8 271.2 279.2 L 136.8 279.2 L 136.8 279.2 L 140.8 302.4 L 140.8 302.4 Q 144.8 316.8 160 317.6 L 258.4 317.6 L 258.4 317.6 Q 256 330.4 256 343.2 Q 256 349.6 256.8 356 L 160 356 L 160 356 Q 138.4 356 123.2 342.4 Q 107.2 329.6 103.2 309.6 L 61.6 92.8 L 61.6 92.8 Q 60.8 87.2 56 87.2 L 19.2 87.2 L 19.2 87.2 Q 1.6 85.6 0 68 L 0 68 Z M 102.4 420 Q 103.2 398.4 121.6 386.4 Q 140.8 376.8 160 386.4 Q 178.4 398.4 179.2 420 Q 178.4 441.6 160 453.6 Q 140.8 463.2 121.6 453.6 Q 103.2 441.6 102.4 420 L 102.4 420 Z M 512 343.2 Q 512 374.4 496.8 400.8 L 496.8 400.8 L 496.8 400.8 Q 481.6 427.2 454.4 443.2 Q 427.2 458.4 396.8 458.4 Q 366.4 458.4 339.2 443.2 Q 312 427.2 296.8 400.8 Q 281.6 374.4 281.6 343.2 Q 281.6 312 296.8 285.6 Q 312 259.2 339.2 243.2 Q 366.4 228 396.8 228 Q 427.2 228 454.4 243.2 Q 481.6 259.2 496.8 285.6 Q 512 312 512 343.2 L 512 343.2 Z M 448 356 Q 460 355.2 460.8 343.2 Q 460 331.2 448 330.4 L 409.6 330.4 L 409.6 330.4 L 409.6 292 L 409.6 292 Q 408.8 280 396.8 279.2 Q 384.8 280 384 292 L 384 330.4 L 384 330.4 L 345.6 330.4 L 345.6 330.4 Q 333.6 331.2 332.8 343.2 Q 333.6 355.2 345.6 356 L 384 356 L 384 356 L 384 394.4 L 384 394.4 Q 384.8 406.4 396.8 407.2 Q 408.8 406.4 409.6 394.4 L 409.6 356 L 409.6 356 L 448 356 L 448 356 Z" /></svg>
            </button>
          </div>) : (<></>)}
        {currentUsername === "" ? (
